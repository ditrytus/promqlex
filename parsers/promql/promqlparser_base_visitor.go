...
func (v *BasePromQLParserVisitor) VisitAt_modifier_timestamp(ctx *At_modifier_timestampContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BasePromQLParserVisitor) VisitString(ctx *StringContext) interface{} {
	return v.VisitChildren(ctx)
}
