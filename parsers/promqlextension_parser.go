...
const (
	...
	PromQLExtensionParserSUBQUERY_RANGE       = 39
	PromQLExtensionParserTIME_RANGE           = 40
	PromQLExtensionParserDURATION             = 41
	PromQLExtensionParserMETRIC_NAME          = 42
	PromQLExtensionParserLABEL_NAME           = 43
	PromQLExtensionParserWS                   = 44
	PromQLExtensionParserSL_COMMENT           = 45
)

// PromQLExtensionParser rules.
const (
	PromQLExtensionParserRULE_expression           = 0
	PromQLExtensionParserRULE_vectorOperation      = 1
	PromQLExtensionParserRULE_unaryOp              = 2
	PromQLExtensionParserRULE_powOp                = 3
	PromQLExtensionParserRULE_multOp               = 4
	PromQLExtensionParserRULE_addOp                = 5
	PromQLExtensionParserRULE_compareOp            = 6
	PromQLExtensionParserRULE_andUnlessOp          = 7
	PromQLExtensionParserRULE_orOp                 = 8
	PromQLExtensionParserRULE_vectorMatchOp        = 9
	PromQLExtensionParserRULE_subqueryOp           = 10
	PromQLExtensionParserRULE_offsetOp             = 11
	PromQLExtensionParserRULE_vector               = 12
	PromQLExtensionParserRULE_parens               = 13
	PromQLExtensionParserRULE_instantSelector      = 14
	PromQLExtensionParserRULE_labelMatcher         = 15
	PromQLExtensionParserRULE_labelMatcherOperator = 16
	PromQLExtensionParserRULE_labelMatcherList     = 17
	PromQLExtensionParserRULE_matrixSelector       = 18
	PromQLExtensionParserRULE_offset               = 19
	PromQLExtensionParserRULE_function_            = 20
	PromQLExtensionParserRULE_parameter            = 21
	PromQLExtensionParserRULE_parameterList        = 22
	PromQLExtensionParserRULE_aggregation          = 23
	PromQLExtensionParserRULE_by                   = 24
	PromQLExtensionParserRULE_without              = 25
	PromQLExtensionParserRULE_grouping             = 26
	PromQLExtensionParserRULE_on_                  = 27
	PromQLExtensionParserRULE_ignoring             = 28
	PromQLExtensionParserRULE_groupLeft            = 29
	PromQLExtensionParserRULE_groupRight           = 30
	PromQLExtensionParserRULE_labelName            = 31
	PromQLExtensionParserRULE_labelNameList        = 32
	PromQLExtensionParserRULE_keyword              = 33
	PromQLExtensionParserRULE_literal              = 34
)
...
func (p *PromQLExtensionParser) Expression() (localctx IExpressionContext) {
	...
	p.EnterRule(localctx, 0, PromQLExtensionParserRULE_expression)
...
func (p *PromQLExtensionParser) vectorOperation(_p int) (localctx IVectorOperationContext) {
	...
	_startState := 2
	p.EnterRecursionRule(localctx, 2, PromQLExtensionParserRULE_vectorOperation, _p)
	var _alt int
...
func (p *PromQLExtensionParser) UnaryOp() (localctx IUnaryOpContext) {
	...
	p.EnterRule(localctx, 4, PromQLExtensionParserRULE_unaryOp)
	var _la int
...
func (p *PromQLExtensionParser) PowOp() (localctx IPowOpContext) {
	...
	p.EnterRule(localctx, 6, PromQLExtensionParserRULE_powOp)
	var _la int
...
func (p *PromQLExtensionParser) MultOp() (localctx IMultOpContext) {
	...
	p.EnterRule(localctx, 8, PromQLExtensionParserRULE_multOp)
	var _la int
...
func (p *PromQLExtensionParser) AddOp() (localctx IAddOpContext) {
	...
	p.EnterRule(localctx, 10, PromQLExtensionParserRULE_addOp)
	var _la int
...
func (p *PromQLExtensionParser) CompareOp() (localctx ICompareOpContext) {
	...
	p.EnterRule(localctx, 12, PromQLExtensionParserRULE_compareOp)
	var _la int
...
func (p *PromQLExtensionParser) AndUnlessOp() (localctx IAndUnlessOpContext) {
	...
	p.EnterRule(localctx, 14, PromQLExtensionParserRULE_andUnlessOp)
	var _la int
...
func (p *PromQLExtensionParser) OrOp() (localctx IOrOpContext) {
	...
	p.EnterRule(localctx, 16, PromQLExtensionParserRULE_orOp)
	var _la int
...
func (p *PromQLExtensionParser) VectorMatchOp() (localctx IVectorMatchOpContext) {
	...
	p.EnterRule(localctx, 18, PromQLExtensionParserRULE_vectorMatchOp)
	var _la int
...
func (p *PromQLExtensionParser) SubqueryOp() (localctx ISubqueryOpContext) {
	...
	p.EnterRule(localctx, 20, PromQLExtensionParserRULE_subqueryOp)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(151)
...
func (p *PromQLExtensionParser) OffsetOp() (localctx IOffsetOpContext) {
	...
	p.EnterRule(localctx, 22, PromQLExtensionParserRULE_offsetOp)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(155)
...
func (p *PromQLExtensionParser) Vector() (localctx IVectorContext) {
	...
	p.EnterRule(localctx, 24, PromQLExtensionParserRULE_vector)
	p.SetState(165)
	p.GetErrorHandler().Sync(p)
	if p.HasError() {
		goto errorExit
...
func (p *PromQLExtensionParser) Parens() (localctx IParensContext) {
	...
	p.EnterRule(localctx, 26, PromQLExtensionParserRULE_parens)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(167)
...
func (p *PromQLExtensionParser) InstantSelector() (localctx IInstantSelectorContext) {
	...
	p.EnterRule(localctx, 28, PromQLExtensionParserRULE_instantSelector)
	var _la int
...
func (p *PromQLExtensionParser) LabelMatcher() (localctx ILabelMatcherContext) {
	...
	p.EnterRule(localctx, 30, PromQLExtensionParserRULE_labelMatcher)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(185)
		p.LabelName()
...
func (p *PromQLExtensionParser) LabelMatcherOperator() (localctx ILabelMatcherOperatorContext) {
	...
	p.EnterRule(localctx, 32, PromQLExtensionParserRULE_labelMatcherOperator)
	var _la int
...
func (p *PromQLExtensionParser) LabelMatcherList() (localctx ILabelMatcherListContext) {
	...
	p.EnterRule(localctx, 34, PromQLExtensionParserRULE_labelMatcherList)
	var _la int
...
func (p *PromQLExtensionParser) MatrixSelector() (localctx IMatrixSelectorContext) {
	...
	p.EnterRule(localctx, 36, PromQLExtensionParserRULE_matrixSelector)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(202)
		p.InstantSelector()
...
func (p *PromQLExtensionParser) Offset() (localctx IOffsetContext) {
	...
	p.EnterRule(localctx, 38, PromQLExtensionParserRULE_offset)
	p.SetState(213)
	p.GetErrorHandler().Sync(p)
	if p.HasError() {
		goto errorExit
...
func (p *PromQLExtensionParser) Function_() (localctx IFunction_Context) {
	...
	p.EnterRule(localctx, 40, PromQLExtensionParserRULE_function_)
	var _la int
...
func (p *PromQLExtensionParser) Parameter() (localctx IParameterContext) {
	...
	p.EnterRule(localctx, 42, PromQLExtensionParserRULE_parameter)
	p.SetState(231)
	p.GetErrorHandler().Sync(p)
	if p.HasError() {
		goto errorExit
...
func (p *PromQLExtensionParser) ParameterList() (localctx IParameterListContext) {
	...
	p.EnterRule(localctx, 44, PromQLExtensionParserRULE_parameterList)
	var _la int
...
func (p *PromQLExtensionParser) Aggregation() (localctx IAggregationContext) {
	...
	p.EnterRule(localctx, 46, PromQLExtensionParserRULE_aggregation)
	p.SetState(261)
	p.GetErrorHandler().Sync(p)
	if p.HasError() {
		goto errorExit
...
func (p *PromQLExtensionParser) By() (localctx IByContext) {
	...
	p.EnterRule(localctx, 48, PromQLExtensionParserRULE_by)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(263)
...
func (p *PromQLExtensionParser) Without() (localctx IWithoutContext) {
	...
	p.EnterRule(localctx, 50, PromQLExtensionParserRULE_without)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(266)
...
func (p *PromQLExtensionParser) Grouping() (localctx IGroupingContext) {
	...
	p.EnterRule(localctx, 52, PromQLExtensionParserRULE_grouping)
	p.EnterOuterAlt(localctx, 1)
	p.SetState(271)
	p.GetErrorHandler().Sync(p)
	if p.HasError() {
...
func (p *PromQLExtensionParser) On_() (localctx IOn_Context) {
	...
	p.EnterRule(localctx, 54, PromQLExtensionParserRULE_on_)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(277)
...
func (p *PromQLExtensionParser) Ignoring() (localctx IIgnoringContext) {
	...
	p.EnterRule(localctx, 56, PromQLExtensionParserRULE_ignoring)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(280)
...
func (p *PromQLExtensionParser) GroupLeft() (localctx IGroupLeftContext) {
	...
	p.EnterRule(localctx, 58, PromQLExtensionParserRULE_groupLeft)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(283)
...
func (p *PromQLExtensionParser) GroupRight() (localctx IGroupRightContext) {
	...
	p.EnterRule(localctx, 60, PromQLExtensionParserRULE_groupRight)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(287)
...
func (p *PromQLExtensionParser) LabelName() (localctx ILabelNameContext) {
	...
	p.EnterRule(localctx, 62, PromQLExtensionParserRULE_labelName)
	p.SetState(294)
	p.GetErrorHandler().Sync(p)
	if p.HasError() {
		goto errorExit
...
func (p *PromQLExtensionParser) LabelNameList() (localctx ILabelNameListContext) {
	...
	p.EnterRule(localctx, 64, PromQLExtensionParserRULE_labelNameList)
	var _la int
...
func (p *PromQLExtensionParser) Keyword() (localctx IKeywordContext) {
	...
	p.EnterRule(localctx, 66, PromQLExtensionParserRULE_keyword)
	var _la int
...
func (p *PromQLExtensionParser) Literal() (localctx ILiteralContext) {
	...
	p.EnterRule(localctx, 68, PromQLExtensionParserRULE_literal)
	var _la int
