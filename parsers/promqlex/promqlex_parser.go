...
func promqlexparserParserInit() {
	...
	staticData.serializedATN = []int32{
		4, 1, 62, 619, 2, 0, 7, 0, 2, 1, 7, 1, 2, 2, 7, 2, 2, 3, 7, 3, 2, 4, 7,
		...
		142, 144, 146, 148, 0, 9, 2, 0, 3, 3, 60, 60, 1, 0, 22, 23, 1, 0, 24, 26,
		1, 0, 34, 39, 2, 0, 28, 28, 30, 30, 2, 0, 30, 30, 44, 44, 3, 0, 33, 33,
		35, 35, 40, 41, 3, 0, 1, 2, 28, 30, 42, 49, 2, 0, 21, 21, 61, 61, 623,
		...
		0, 166, 167, 5, 16, 0, 0, 167, 168, 5, 60, 0, 0, 168, 169, 5, 33, 0, 0,
		169, 170, 3, 74, 37, 0, 170, 5, 1, 0, 0, 0, 171, 172, 5, 17, 0, 0, 172,
		173, 5, 60, 0, 0, 173, 7, 1, 0, 0, 0, 174, 175, 5, 16, 0, 0, 175, 176,
		5, 60, 0, 0, 176, 178, 5, 52, 0, 0, 177, 179, 3, 12, 6, 0, 178, 177, 1,
		0, 0, 0, 178, 179, 1, 0, 0, 0, 179, 180, 1, 0, 0, 0, 180, 181, 5, 53, 0,
		0, 181, 182, 3, 16, 8, 0, 182, 9, 1, 0, 0, 0, 183, 184, 5, 17, 0, 0, 184,
		185, 5, 60, 0, 0, 185, 186, 5, 60, 0, 0, 186, 188, 5, 52, 0, 0, 187, 189,
		3, 18, 9, 0, 188, 187, 1, 0, 0, 0, 188, 189, 1, 0, 0, 0, 189, 190, 1, 0,
		0, 0, 190, 191, 5, 53, 0, 0, 191, 11, 1, 0, 0, 0, 192, 197, 3, 14, 7, 0,
		193, 194, 5, 54, 0, 0, 194, 196, 3, 14, 7, 0, 195, 193, 1, 0, 0, 0, 196,
		199, 1, 0, 0, 0, 197, 195, 1, 0, 0, 0, 197, 198, 1, 0, 0, 0, 198, 13, 1,
		0, 0, 0, 199, 197, 1, 0, 0, 0, 200, 201, 5, 60, 0, 0, 201, 15, 1, 0, 0,
		0, 202, 203, 5, 50, 0, 0, 203, 204, 3, 0, 0, 0, 204, 205, 5, 51, 0, 0,
		205, 17, 1, 0, 0, 0, 206, 209, 3, 74, 37, 0, 207, 208, 5, 54, 0, 0, 208,
		...
		51, 0, 329, 330, 3, 66, 33, 0, 330, 337, 1, 0, 0, 0, 331, 332, 5, 52, 0,
		0, 332, 333, 3, 64, 32, 0, 333, 334, 5, 53, 0, 0, 334, 337, 1, 0, 0, 0,
		335, 337, 3, 66, 33, 0, 336, 316, 1, 0, 0, 0, 336, 320, 1, 0, 0, 0, 336,
		323, 1, 0, 0, 0, 336, 327, 1, 0, 0, 0, 336, 331, 1, 0, 0, 0, 336, 335,
		1, 0, 0, 0, 337, 65, 1, 0, 0, 0, 338, 343, 5, 20, 0, 0, 339, 343, 5, 56,
		...
		5, 55, 0, 0, 399, 401, 3, 94, 47, 0, 400, 367, 1, 0, 0, 0, 400, 371, 1,
		...
		0, 408, 77, 1, 0, 0, 0, 409, 410, 5, 48, 0, 0, 410, 411, 3, 68, 34, 0,
		411, 79, 1, 0, 0, 0, 412, 413, 3, 86, 43, 0, 413, 414, 3, 70, 35, 0, 414,
		81, 1, 0, 0, 0, 415, 416, 3, 86, 43, 0, 416, 417, 5, 48, 0, 0, 417, 418,
		3, 68, 34, 0, 418, 424, 1, 0, 0, 0, 419, 420, 3, 80, 40, 0, 420, 421, 5,
		48, 0, 0, 421, 422, 3, 68, 34, 0, 422, 424, 1, 0, 0, 0, 423, 415, 1, 0,
		0, 0, 423, 419, 1, 0, 0, 0, 424, 83, 1, 0, 0, 0, 425, 428, 3, 64, 32, 0,
		426, 428, 3, 148, 74, 0, 427, 425, 1, 0, 0, 0, 427, 426, 1, 0, 0, 0, 428,
		85, 1, 0, 0, 0, 429, 435, 3, 90, 45, 0, 430, 432, 5, 50, 0, 0, 431, 433,
		3, 120, 60, 0, 432, 431, 1, 0, 0, 0, 432, 433, 1, 0, 0, 0, 433, 434, 1,
		0, 0, 0, 434, 436, 5, 51, 0, 0, 435, 430, 1, 0, 0, 0, 435, 436, 1, 0, 0,
		0, 436, 442, 1, 0, 0, 0, 437, 438, 5, 50, 0, 0, 438, 439, 3, 120, 60, 0,
		439, 440, 5, 51, 0, 0, 440, 442, 1, 0, 0, 0, 441, 429, 1, 0, 0, 0, 441,
		437, 1, 0, 0, 0, 442, 87, 1, 0, 0, 0, 443, 447, 3, 146, 73, 0, 444, 447,
		3, 90, 45, 0, 445, 447, 5, 57, 0, 0, 446, 443, 1, 0, 0, 0, 446, 444, 1,
		0, 0, 0, 446, 445, 1, 0, 0, 0, 447, 89, 1, 0, 0, 0, 448, 449, 7, 0, 0,
		0, 449, 91, 1, 0, 0, 0, 450, 451, 3, 74, 37, 0, 451, 452, 5, 0, 0, 1, 452,
		93, 1, 0, 0, 0, 453, 461, 5, 20, 0, 0, 454, 455, 5, 31, 0, 0, 455, 456,
		5, 52, 0, 0, 456, 461, 5, 53, 0, 0, 457, 458, 5, 32, 0, 0, 458, 459, 5,
		52, 0, 0, 459, 461, 5, 53, 0, 0, 460, 453, 1, 0, 0, 0, 460, 454, 1, 0,
		...
		478, 7, 3, 0, 0, 477, 479, 5, 49, 0, 0, 478, 477, 1, 0, 0, 0, 478, 479,
		...
		113, 1, 0, 0, 0, 504, 505, 5, 52, 0, 0, 505, 506, 3, 74, 37, 0, 506, 507,
		5, 53, 0, 0, 507, 115, 1, 0, 0, 0, 508, 509, 3, 88, 44, 0, 509, 510, 3,
		118, 59, 0, 510, 511, 3, 148, 74, 0, 511, 117, 1, 0, 0, 0, 512, 513, 7,
		6, 0, 0, 513, 119, 1, 0, 0, 0, 514, 519, 3, 116, 58, 0, 515, 516, 5, 54,
		0, 0, 516, 518, 3, 116, 58, 0, 517, 515, 1, 0, 0, 0, 518, 521, 1, 0, 0,
		0, 519, 517, 1, 0, 0, 0, 519, 520, 1, 0, 0, 0, 520, 523, 1, 0, 0, 0, 521,
		519, 1, 0, 0, 0, 522, 524, 5, 54, 0, 0, 523, 522, 1, 0, 0, 0, 523, 524,
		1, 0, 0, 0, 524, 121, 1, 0, 0, 0, 525, 526, 5, 2, 0, 0, 526, 535, 5, 52,
		0, 0, 527, 532, 3, 124, 62, 0, 528, 529, 5, 54, 0, 0, 529, 531, 3, 124,
		...
		5, 53, 0, 0, 538, 123, 1, 0, 0, 0, 539, 542, 3, 84, 42, 0, 540, 542, 3,
		74, 37, 0, 541, 539, 1, 0, 0, 0, 541, 540, 1, 0, 0, 0, 542, 125, 1, 0,
		0, 0, 543, 552, 5, 52, 0, 0, 544, 549, 3, 124, 62, 0, 545, 546, 5, 54,
		...
		1, 0, 0, 0, 554, 555, 5, 53, 0, 0, 555, 127, 1, 0, 0, 0, 556, 557, 5, 1,
		...
		1, 0, 0, 0, 572, 129, 1, 0, 0, 0, 573, 574, 5, 42, 0, 0, 574, 575, 3, 144,
		72, 0, 575, 131, 1, 0, 0, 0, 576, 577, 5, 43, 0, 0, 577, 578, 3, 144, 72,
		...
		5, 44, 0, 0, 588, 589, 3, 144, 72, 0, 589, 137, 1, 0, 0, 0, 590, 591, 5,
		45, 0, 0, 591, 592, 3, 144, 72, 0, 592, 139, 1, 0, 0, 0, 593, 595, 5, 46,
		0, 0, 594, 596, 3, 144, 72, 0, 595, 594, 1, 0, 0, 0, 595, 596, 1, 0, 0,
		0, 596, 141, 1, 0, 0, 0, 597, 599, 5, 47, 0, 0, 598, 600, 3, 144, 72, 0,
		599, 598, 1, 0, 0, 0, 599, 600, 1, 0, 0, 0, 600, 143, 1, 0, 0, 0, 601,
		610, 5, 52, 0, 0, 602, 607, 3, 88, 44, 0, 603, 604, 5, 54, 0, 0, 604, 606,
		...
		613, 5, 53, 0, 0, 613, 145, 1, 0, 0, 0, 614, 615, 7, 7, 0, 0, 615, 147,
...
const (
	...
	PromQLExParserSTART                = 31
	PromQLExParserEND                  = 32
	PromQLExParserEQ                   = 33
	PromQLExParserDEQ                  = 34
	PromQLExParserNE                   = 35
	PromQLExParserGT                   = 36
	PromQLExParserLT                   = 37
	PromQLExParserGE                   = 38
	PromQLExParserLE                   = 39
	PromQLExParserRE                   = 40
	PromQLExParserNRE                  = 41
	PromQLExParserBY                   = 42
	PromQLExParserWITHOUT              = 43
	PromQLExParserON                   = 44
	PromQLExParserIGNORING             = 45
	PromQLExParserGROUP_LEFT           = 46
	PromQLExParserGROUP_RIGHT          = 47
	PromQLExParserOFFSET               = 48
	PromQLExParserBOOL                 = 49
	PromQLExParserLEFT_BRACE           = 50
	PromQLExParserRIGHT_BRACE          = 51
	PromQLExParserLEFT_PAREN           = 52
	PromQLExParserRIGHT_PAREN          = 53
	PromQLExParserCOMMA                = 54
	PromQLExParserAT                   = 55
	PromQLExParserDURATION             = 56
	PromQLExParserLABEL_NAME           = 57
	PromQLExParserWS                   = 58
	PromQLExParserSL_COMMENT           = 59
	PromQLExParserID                   = 60
	PromQLExParserRAW_STRING           = 61
	PromQLExParserBACKTICK_OPEN        = 62
)
...
func (p *PromQLExParser) Macro_call() (localctx IMacro_callContext) {
	...
	if (int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&3536451607408543758) != 0 {
		{
			p.SetState(187)
			p.Arg_list()
		}
...
func (p *PromQLExParser) Subquery_range() (localctx ISubquery_rangeContext) {
	...
	if (int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&76561193679063040) != 0 {
		{
			p.SetState(353)
			p.Duration()
		}
...
func (p *PromQLExParser) InstantSelector() (localctx IInstantSelectorContext) {
	...
	case PromQLExParserMETRIC_NAME, PromQLExParserID:
		...
		if p.GetInterpreter().AdaptivePredict(p.BaseParser, p.GetTokenStream(), 19, p.GetParserRuleContext()) == 1 {
			...
			if (int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&1298158196422082574) != 0 {
				{
					p.SetState(431)
					p.LabelMatcherList()
				}
...
func (p *PromQLExParser) LabelMatcherOperator() (localctx ILabelMatcherOperatorContext) {
	...
	p.EnterOuterAlt(localctx, 1)
	{
		...
		if !((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&3341484556288) != 0) {
			p.GetErrorHandler().RecoverInline(p)
		} else {
			p.GetErrorHandler().ReportMatch(p)
			p.Consume()
...
func (p *PromQLExParser) Keyword() (localctx IKeywordContext) {
	...
	p.EnterOuterAlt(localctx, 1)
	{
		...
		if !((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&1121503739379718) != 0) {
			p.GetErrorHandler().RecoverInline(p)
		} else {
			p.GetErrorHandler().ReportMatch(p)
			p.Consume()
